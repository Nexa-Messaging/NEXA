...
/**
 * Static palette mirroring the warm light (latte cream) tokens. Screens and
 * components use `useAppTheme()` for mode-aware colors; this static export
 * exists for tokens that are invariant (accents) and as the light fallback.
 */
